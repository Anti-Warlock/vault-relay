...
它不会要求你迁移 Vault，也不会替换你的创作工具。文章仍然写在 Obsidian 中，插件负责理解 Markdown 结构、检查发布问题，并生成可直接使用的发布成品。
...
```text
你的仓库/.obsidian/plugins/obsidian-publish-studio/
```
...
重启 Obsidian，在第三方插件中启用 **Obsidian Publish Studio**。
...
- 推广视频：`promo/obsidian-publish-studio-demo.mp4`
